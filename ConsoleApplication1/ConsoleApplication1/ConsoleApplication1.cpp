...
const std::string ORIGIN_DIR = "/home/bernardo/";

const std::string APP_DIR = ORIGIN_DIR + "Ibex/ibex-2.8.9/examples/ConsoleApplication1/ConsoleApplication1/";
...
void createIntersections(int id) {
    ...
    std::ifstream test(APP_DIR+"/roadNetworks/" + to_string(id) + EXT_JSON, std::ifstream::binary);
    cout << APP_DIR+"/roadNetworks/" + to_string(id) + EXT_JSON << endl;
    bool parsingSuccessful = reader.parse(test, root, false);
    if (!parsingSuccessful) {
        cout << "error creating intersections!" << endl;
    }
    int count = 1;
    ...
    std::ofstream test1(APP_DIR + "/roadNetworks/" +to_string(id) + "withIntersections" + EXT_JSON);;
...
class Car {
    ...
    public:
        ...
        void save_use_case(string system, string solution, ScenarioSolve* slv) {
            ...
            copyFile("/home/bernardo/Ibex/ibex-2.8.9/ConsoleApplication1/ConsoleApplication1/"+ to_string(slv->scn->roadNet->id) + "withIntersections.json", "/home/bernardo/Ibex/ibex-2.8.9/ConsoleApplication1/ConsoleApplication1/"+ to_string(slv->scn->roadNet->id) +"withIntersections.json");
            //sample_json - transfer
            copyFile("/home/bernardo/Ibex/ibex-2.8.9/ConsoleApplication1/ConsoleApplication1/sample.json", "/home/bernardo/Documents/Use cases/sample.json");
    ...
    Scenario* processJson(string filename) {
        ...
        Json::Value root_alt;
        std::ifstream test1(APP_DIR+"/roadNetworks/" + root["networkID"].asString() + "withIntersections" + EXT_JSON, std::ifstream::binary);
...
*/
    ...
    void save(string content, string path) {
        ofstream myfile;
        myfile.open(path + "example_results_report.txt");
        myfile << content;
        myfile.close();
    }
    ...
    void run_default(){
        ...
        Scenario* scn = processJson(APP_DIR+"example.json");
