...
if __name__ == '__main__':
    file = origin_dir + "/Ibex/ibex-2.8.9/examples/ConsoleApplication1/ConsoleApplication1/example.dsl"
    file_spec = origin_dir + "/Ibex/ibex-2.8.9/examples/ConsoleApplication1/ConsoleApplication1/test_generation/general_chasings/example0_0.dsl"
    newdir = origin_dir + "/Ibex/ibex-2.8.9/examples/ConsoleApplication1/ConsoleApplication1/"
